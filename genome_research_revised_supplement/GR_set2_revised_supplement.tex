...
\begin{table}[ht!]
\center
\includegraphics[width=\textwidth, trim={0in 2.5in 0in 1in}, clip]{Supplemental_Table1.pdf}
\end{table}

\subsection{Table S2: Plasmids used in this study and their Addgene deposition IDs.}
\begin{table}[ht!]
\center
\includegraphics[width=\textwidth, trim={0in 9in 0in 1in}, clip]{Supplemental_Table2.pdf}
\end{table}
...
\begin{figure}[ht!]
\center
\includegraphics[width=\textwidth, trim={0in 2in 0in 1in}, clip]{Supplemental_Note.pdf}
\end{figure}
